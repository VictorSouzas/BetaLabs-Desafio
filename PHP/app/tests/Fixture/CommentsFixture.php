...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'user_key' => ['type' => 'index', 'columns' => ['owner'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'user_key' => ['type' => 'foreign', 'columns' => ['owner'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
